...
| `SQL_Two_Products_Plan.md` | 13 September | Proposal: one SQL set per postcode product, no default, same interface, each step tied to PHS/NRS guidance. Implemented in 2.1.0. |
