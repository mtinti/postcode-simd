...
| `Exports_Plan.md` | 16 September | Revised proposal: gzipped CSVs and coordinate-free SQL output under one export contract, typed import, and compact SQL Server schema/key/count/digest checks with reviewed lookup examples. Full reference-table cell comparison deferred. Not implemented. |
