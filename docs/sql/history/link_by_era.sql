...
-- event_date must be a date/datetime; reject invalid date text before this query.
-- SQL Server TIMESTAMP means rowversion, not a date.
...
-- use the SAME latest-postcode/linked-small-user view. See README.md.
