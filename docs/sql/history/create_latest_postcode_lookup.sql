...
SELECT p.pc_base AS postcode_key,
       ...
       'spd' AS index_source,
       p.spd_release AS index_release,
       'postcode_grid_reference' AS allocation,
       p.LinkedSmallUserPostcode AS requested_link_postcode,
       CASE
